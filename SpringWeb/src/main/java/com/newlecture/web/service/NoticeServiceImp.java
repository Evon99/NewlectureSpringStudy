...
@Service // @Component(범용), @Service, @Controller, @Repository, @Configuration ... -> 특화 이름
public class NoticeServiceImp implements NoticeService{
	...
	@Override
	public int updatePubAll(int[] pubsIds, int[] closeIds) {
		// TODO Auto-generated method stub
		int result = 0;
		result += noticeDao.updatePubAll(pubsIds, true);
